...
export default function App() {
    ...
    return (
        <div className='w-full h-screen flex justify-center items-center'>
            <div className="MAIN_CONTAINER w-120 bg-blue-100 p-5 rounded-lg flex flex-col justify-center  items-center">
                <h1 className="TITLE text-2xl font-semibold text-gray-500 border-b border-gray-500 p-5"
                >Character Counter Project</h1>
                ...
                <div className="PREVIEW_ROW flex items-center m-2 w-full">
                    <div className="INPUT text-lg px-2 py-1 mx-2 text-blue-500 font-bold">Length : </div>
